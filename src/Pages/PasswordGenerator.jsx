...
//     // Set validation error if the value is zero or less
//     if (newValue <= 0) {
//       setError("Please choose a character length greater than 0.");
//     } else {
...
//   return (
//     <div className="bg-[#100F15] h-screen flex flex-col items-center justify-center px-4 sm:px-8 py-52">
...
export const PasswordGenerator = () => {
  ...
  const handleSliderChange = (e) => {
    ...
    // Set validation error if value is zero or less
    if (newValue === 0) {
      setError("Please choose a character length greater than 0.");
    } else {
      setError(""); // Clear error if value is valid
  ...
  const generatePassword = () => {
    ...
    // Check for valid length and character set
    if (value === 0) {
      setError("Please choose a character length greater than 0.");
      return;
    }
  ...
  return (
    <div className="bg-[#100F15] md:h-screen flex flex-col items-center justify-center px-4 sm:px-8 py-5">
      <h1 className="text-[#817F8D] font-NotoSans font-bold mb-3">
        Password Generator
      </h1>
